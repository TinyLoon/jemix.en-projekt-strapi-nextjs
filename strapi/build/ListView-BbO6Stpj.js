import{d as h,a7 as m,e2 as y,j as e,F as x,T as f,c as ge,f as L,k as A,ah as S,p as oe,bc as X,bd as q,be as P,bf as Z,bi as _,bj as G,ae as Q,n as Y,D as N,bl as fe,aJ as se,I as ee,b as ie,bb as xe,cA as be,aj as je,z as ye,er as Ce,ai as we,ft as Te,bX as te,fu as ve,E as ke,b5 as $e,B as ae}from"./strapi-w3l9_OYo.js";import{u as D,C as ne,g as u,a as re,A as Me}from"./index-HaOlkjEx.js";import"./groupBy-DtqsCtNn.js";import"./_baseEach-B7vKpw-x.js";import"./index-CowOeAsA.js";import"./index-BRVyLNfZ.js";import"./sortBy-DKAl6TJd.js";import"./_baseMap-FzRmIcy-.js";const Fe=h(m)`
  table {
    width: 100%;
    white-space: nowrap;
  }
...
`,de=({customRowComponent:t,component:n,isFromDynamicZone:o=!1,isNestedInDZComponent:s=!1,firstLoopComponentUid:r})=>{const{modifiedData:i}=D(),{schema:{attributes:p}}=y(i,["components",n],{schema:{attributes:[]}});return e.jsx(le,{$isChildOfDynamicZone:o,className:"component-row",children:e.jsx("td",{colSpan:12,children:e.jsx(pe,{customRowComponent:t,items:p,targetUid:n,firstLoopComponentUid:r||n,editTarget:"components",isFromDynamicZone:o,isNestedInDZComponent:s,isSub:!0,secondLoopComponentUid:r?n:null})})})},Ie=({isActive:t=!1,icon:n="dashboard"})=>{const o=ne[n]||ne.dashboard;return e.jsx(x,{alignItems:"center",background:t?"primary200":"neutral200",justifyContent:"center",height:8,width:8,borderRadius:"50%",children:e.jsx(o,{height:"2rem",width:"2rem"})})},ce=h(m)`
  position: absolute;
  display: none;
  top: 5px;
  right: 0.8rem;
...
`,De=({component:t,dzName:n,index:o,isActive:s=!1,isInDevelopmentMode:r=!1,onClick:i})=>{const{modifiedData:p,removeComponentFromDynamicZone:j}=D(),{schema:{icon:b,displayName:g}}=y(p,["components",t],{schema:{}}),l=a=>{a.stopPropagation(),j(n,o)};return e.jsxs(Ae,{alignItems:"center",direction:"column",className:s?"active":"",borderRadius:"borderRadius",justifyContent:"center",paddingLeft:4,paddingRight:4,shrink:0,onClick:i,role:"tab",tabIndex:s?0:-1,cursor:"pointer","aria-selected":s,"aria-controls":`dz-${n}-panel-${o}`,id:`dz-${n}-tab-${o}`,children:[e.jsx(Ie,{icon:b,isActive:s}),e.jsx(m,{marginTop:1,maxWidth:"100%",children:e.jsx(f,{variant:"pi",fontWeight:"bold",ellipsis:!0,children:g})}),r&&e.jsx(ce,{tag:"button",onClick:l,children:e.jsx(ge,{})})]})},Re=h(S)`
  width: 3.2rem;
  height: 3.2rem;
  padding: 0.9rem;
